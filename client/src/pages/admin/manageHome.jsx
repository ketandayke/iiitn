// // Updated ManageHome.jsx with Dynamic Content Types and Additional Features
...
//                     {/* Counters Section - Upload Number and Text */}
//                     <Section alias={alias} sectionName="counters" allowedContentTypes={["number"]} multiple={true} />

//                     {/* IIITN at a Glance - Upload Image with Heading and Description */}
//                     <Section alias={alias} sectionName="iiitn-at-a-glance" allowedContentTypes={["image"]} multiple={false} />

//                     {/* Testimonials Section - Upload Image, Text, and Approve/Reject */}
//                     <Section alias={alias} sectionName="testimonials" allowedContentTypes={["image"]} multiple={true} showApprovalOptions={true} />
