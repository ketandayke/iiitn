...
const AdministrativeHeadForm = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setSubmitMessage({
        type: "success",
        message: "Administrative head added successfully!",
      });
      ...
      setSubmitMessage({
        type: "error",
        message: error.response?.data?.message || "Failed to add administrative head. Please try again.",
      });
    } finally {
        ...
        return (
          <div className="p-4 border border-blue-200 rounded-lg bg-blue-50">
            ...
            <textarea
              ...
              placeholder="Enter the director's vision for the institution"
      ...
      case "Chairman":
        return (
          <div className="p-4 border border-blue-200 rounded-lg bg-blue-50">
            ...
            <textarea
              name="agenda"
              placeholder="Enter the chairman's agenda"
        ...
        return (
          ...
          <div className="p-4  border border-blue-200 rounded-lg bg-blue-50">
            ...
            <textarea
              ...
              placeholder="Enter the registrar's responsibilities (separate with commas)"
            ...
            <p className="text-xs text-gray-500 mt-1">
              Separate different responsibilities with commas
            </p>
          </div>
        );
      default:
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="md:col-span-2">
            ...
            <textarea
              name="experience"
              placeholder="15+ years in academia with focus on..."
          ...
          <div>
            ...
            <select
              ...
              value={formData.role}
              onChange={handleChange}
              className="w-full p-3 rounded-lg border border-gray-300 focus:ring-2 focus:ring-blue-500 focus:border-transparent transition duration-200 bg-white"
              required
            >
          ...
          <div>
            ...
            <input
              ...
              placeholder="Main Building, Room 203"
        ...
        <div className="pt-4">
          ...
          >
            {isSubmitting ? "Submitting..." : "Add Administrative Head"}
          </button>
        </div>
      </form>
    </div>
...
export default AdministrativeHeadForm;